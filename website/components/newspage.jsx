                      ...
                      >
                        <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl">
                          <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                              <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <Dialog.Title
                                  as="h3"
                                  className="text-sm font-serif leading-6 text-gray-500"
                                >
                                  {newsData[popUpIndex].date} |{" "}
                                  {newsData[popUpIndex].source}
                                </Dialog.Title>
                                <Dialog.Title
                                  as="h3"
                                  className="text-3xl font-serif font-semibold leading-10 text-gray-900"
                                >
                                  {newsData[popUpIndex].title}
                                </Dialog.Title>
                                <div className="mt-2">
                                  <p className="text-lg font-serif italic leading-8 text-gray-600 pt-1 pb-5">
                                    {newsData[popUpIndex].description}
                                  </p>
                                  <p className="text-md font-serif leading-8 text-gray-600">
                          ...
                          <div className="bg-gray-50 px-4 py-3 flex justify-center items-center sm:flex sm:flex-row-reverse sm:px-6">
                            <a
                              type="button"
                              className="inline-flex w-full font-serif justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-transparent hover:text-blue-500 hover:border hover:border-blue-500 sm:ml-3 sm:w-auto"
                            ...
                            <button
                              type="button"
                              className="mt-3 inline-flex w-full font-serif justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto"
                              onClick={() => closePopup()}
                              ref={cancelButtonRef}
                            >
                              Close
